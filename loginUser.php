...
<body>
    ...
    <div class="container">
        <form action="loginUser.php" method="POST" onsubmit="return validate()">
        ...
        <button onclick="location.href = 'sinupUser.php';" class="btn btn-warning btn-lg btn-block my-2">Sinup</button>
    </div>
